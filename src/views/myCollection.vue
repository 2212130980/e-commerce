          ...
          <div>
            ...
            <div class="cart-table">
              <div class="cart-group">
                <!--购物列表-->
                <div class="cart-top-items" v-for="(item,index) in productList1">
                  <div class="cart-items">
                    <div class="items-choose">
                      ...
                      <!--                      <input type="checkbox" name="subBox" v-model="item.checked">-->
                    </div>
                    <div v-for="items in item.productEntities">
        ...
        <div class="cart-bottom-bg fix-bottom">
          <div class="cart-bar-operation">
            <div>
              ...
              <button :disabled="!fruitIds.length>0" value="Delete" @click="deleteFruits()">删除选中的商品</button>
            </div>
          </div>
          <br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  export default {
    ...
    methods: {
      init() {
        ...
        this.$axios
          .post(`/hammercollect/list`, form)
          .then(({data}) => {
            console.log(data);
            if (data && data.code === 0) {
              // data.page
              this.productList1 = data.page.records;
...
//                  },this)
          this.productList1.forEach((val, index) => {
      ...
      deleteFruits() {
        ...
        if (confirm("确定要删除选中的商品吗？")) {
          this.$axios
            .post(`/hammercollect/delete`, "ids=" + this.fruitIds)
            .then(({data}) => {
              if (data.code === 0) {
                this.$message({
                  message: '删除成功',
      ...
      delCarPanelHandle(id) {
        if (confirm("确定要当前的商品吗？")) {
          this.$axios
            .post(`/hammercollect/delete`, "ids=" + id)
            .then(({data}) => {
              if (data.code === 0) {
                this.$message({
                  message: '删除成功',
